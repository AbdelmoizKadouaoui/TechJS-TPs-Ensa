...
async function load() {
    ...
    el.list.querySelectorAll('article').forEach(article => {
        ...
        const del = article.querySelector('.btn-del');
        const save = article.querySelector('.btn-save');
        const inp = article.querySelector('.inp');
...
el.form.onsubmit = async (e) => {
    ...
    const payload = {
        ...
        status: String(fd.get('status') ?? 'Want to read'),
